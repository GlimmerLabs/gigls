...
(define plug-in-metadata-editor (loudbus-helper 'plug_in_metadata_editor))
...
(define file-jpeg-load-thumb (loudbus-helper 'file_jpeg_load_thumb))
...
(define plug-in-metadata-decode-exif (loudbus-helper 'plug_in_metadata_decode_exif))
...
(define test-bytes-get (loudbus-helper 'test_bytes_get))
...
(define test-bytes-put (loudbus-helper 'test_bytes_put))
...
(define file-jp2-load (loudbus-helper 'file_jp2_load))
...
(define ggimp-rgb-parse (loudbus-helper 'ggimp_rgb_parse))
...
(define plug-in-web-page (loudbus-helper 'plug_in_web_page))
